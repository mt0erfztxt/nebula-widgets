(ns nebula-widgets.kitchen-sink.views
  (:require
    ...
    [nebula-widgets.kitchen-sink.panels.checkbox-input-widget.views :as checkbox-input-widget-panel-views]
    ...
    [nebula-widgets.kitchen-sink.panels.radio-input-widget.views :as radio-input-widget-panel-views]
  ...
  (let [*route (rf/subscribe [:app/route])]
    (fn []
      (case (:id @*route)
        ...
        :widgets/checkbox-input [checkbox-input-widget-panel-views/widget]
        ...
        :widgets/radio-input [radio-input-widget-panel-views/widget]
