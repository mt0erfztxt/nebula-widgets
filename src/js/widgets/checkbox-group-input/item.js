 ...
 * @type {String}
 */
const fragmentDisplayName = 'nebula-widgets.widgets.checkbox-group-input.item';

/**
 * Fragment that represents checkbox group input item.
 */
class CheckboxGroupInputItem extends CheckableGroupInputItem {

  /**
   * Creates fragment.
   *
   * @param {CheckboxGroupInputItem|Object} [spec] When it's already instance of `CheckboxGroupInputItem` it would be returned as-is otherwise it's same as extended fragment's constructor `spec` parameter
...
Object.defineProperties(CheckboxGroupInputItem, {
  bemBase: {
    value: 'nw-checkboxGroupInput-item'
  },
  displayName: {
